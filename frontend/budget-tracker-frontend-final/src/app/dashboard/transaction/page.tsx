  ...
  return (
    <div className="p-4 space-y-6">
            ...
            <tbody>
              {transaction.length > 0 ? (
                transaction.map((tx, idx) => {
                  ...
                  return (
                    <tr key={idx} className="border-t text-gray-500">
      ...
      <div className="flex flex-wrap justify-end items-center gap-2 text-sm">
        <button
          className="px-3 py-1 border rounded hover:bg-gray-100  disabled:bg-gray-500 disabled:text-white disabled:rounded-md"
          disabled={page === 1}
        ...
        <button
          className="px-3 py-1 border rounded hover:bg-gray-100 disabled:bg-gray-500"
          disabled={page === totalPage}
          onClick={() => setPage((prev) => Math.max(prev + 1, totalPage))}
        >
          Next
        </button>
      </div>
